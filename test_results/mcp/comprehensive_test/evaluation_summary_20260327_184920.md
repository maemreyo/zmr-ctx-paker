...
- Duration: 142ms
- Details: `{"error_detected": true, "error_type": "validation_error", "response": {"jsonrpc": "2.0", "id": 1774611963910, "result": {"content": [{"type": "text", "text": "{\"error\": \"INVALID_ARGUMENT\", \"mess...`
...
- Duration: 168ms
- Details: `{"avg_latency_ms": 167.787504196167, "min_latency_ms": 147.813081741333, "max_latency_ms": 178.4501075744629, "std_dev_ms": 11.973664102328492, "samples": 5}...`

**✅ performance/search_latency** (Score: 100%)
- Duration: 30ms
- Details: `{"mode": "warm-path (persistent process)", "cold_start_ms": 10361.4, "avg_warm_ms": 30.4, "max_warm_ms": 32.6, "p99_warm_ms": 32.6, "samples": 4, "error": ""}...`

**✅ performance/pack_context_latency** (Score: 80%)
- Duration: 2430ms
- Details: `{"mode": "warm-path (persistent process)", "cold_start_ms": 9560.7, "avg_warm_ms": 2429.7, "samples": 3, "error": ""}...`
...
- Duration: 607ms
- Details: `{"total_requests": 10, "successful": 10, "errors": 0, "total_duration_ms": 607.0051193237305, "success_rate": 1.0}...`
...
- Duration: 184ms
- Details: `{"duration_ms": 184.11898612976074, "timeout_set": 5}...`
...
- Duration: 146ms
- Details: `{"expected": ["GraphStore", "callers_of", "_query"], "found": [], "missing": ["GraphStore", "callers_of", "_query"], "total_symbols": 0, "graph_unavailable": true}...`
