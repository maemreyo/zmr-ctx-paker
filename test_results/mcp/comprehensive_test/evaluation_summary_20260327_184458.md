...
- Duration: 145ms
- Details: `{"error_detected": true, "error_type": "validation_error", "response": {"jsonrpc": "2.0", "id": 1774611686488, "result": {"content": [{"type": "text", "text": "{\"error\": \"INVALID_ARGUMENT\", \"mess...`
...
- Duration: 156ms
- Details: `{"avg_latency_ms": 155.87477684020996, "min_latency_ms": 152.6808738708496, "max_latency_ms": 166.3219928741455, "std_dev_ms": 5.8598268180927375, "samples": 5}...`

**✅ performance/search_latency** (Score: 100%)
- Duration: 27ms
- Details: `{"mode": "warm-path (persistent process)", "cold_start_ms": 10011.0, "avg_warm_ms": 26.7, "max_warm_ms": 29.6, "p99_warm_ms": 29.6, "samples": 4, "error": ""}...`

**✅ performance/pack_context_latency** (Score: 80%)
- Duration: 4090ms
- Details: `{"mode": "warm-path (persistent process)", "cold_start_ms": 9892.7, "avg_warm_ms": 4089.7, "samples": 3, "error": ""}...`
...
- Duration: 587ms
- Details: `{"total_requests": 10, "successful": 10, "errors": 0, "total_duration_ms": 587.3270034790039, "success_rate": 1.0}...`
...
- Duration: 183ms
- Details: `{"duration_ms": 182.70421028137207, "timeout_set": 5}...`
...
- Duration: 151ms
- Details: `{"expected": ["callers_of", "GraphStore", "_query"], "found": [], "missing": ["callers_of", "GraphStore", "_query"], "total_symbols": 0, "graph_unavailable": true}...`

**❌ graph_tools/call_chain/max_depth_capped** (Score: 0%)
- Duration: 145ms
- Details: `{"accepted_depth_20": false, "has_path": false, "path": null}...`

**✅ graph_tools/call_chain/self_path_single_element** (Score: 100%)
- Duration: 144ms
- Details: `{"path": [], "expected": ["_query"], "graph_unavailable": true}...`

**❌ graph_tools/call_chain/no_path_returns_empty_list** (Score: 0%)
- Duration: 147ms
- Details: `{"path": null, "expected": []}...`
...
Based on the test results, this MCP server achieves a **95%** compliance score.
