...
- Duration: 230ms
- Details: `{"error_detected": true, "error_type": "validation_error", "response": {"jsonrpc": "2.0", "id": 1774608082288, "result": {"content": [{"type": "text", "text": "{\"error\": \"INVALID_ARGUMENT\", \"mess...`
...
- Duration: 334ms
- Details: `{"avg_latency_ms": 334.27319526672363, "min_latency_ms": 292.6168441772461, "max_latency_ms": 378.4372806549072, "std_dev_ms": 37.07202497621075, "samples": 5}...`

**✅ performance/search_latency** (Score: 100%)
- Duration: 20ms
- Details: `{"mode": "warm-path (persistent process)", "cold_start_ms": 10606.8, "avg_warm_ms": 20.2, "max_warm_ms": 22.1, "p99_warm_ms": 22.1, "samples": 4, "error": ""}...`

**✅ performance/pack_context_latency** (Score: 100%)
- Duration: 121ms
- Details: `{"mode": "warm-path (persistent process)", "cold_start_ms": 10209.7, "avg_warm_ms": 121.5, "samples": 3, "error": ""}...`
...
- Duration: 1830ms
- Details: `{"total_requests": 10, "successful": 10, "errors": 0, "total_duration_ms": 1830.4450511932373, "success_rate": 1.0}...`
...
- Duration: 286ms
- Details: `{"duration_ms": 285.97116470336914, "timeout_set": 5}...`
...
- Duration: 3ms
- Details: `{"avg_warm_ms": 2.9, "samples": 5, "error": ""}...`
