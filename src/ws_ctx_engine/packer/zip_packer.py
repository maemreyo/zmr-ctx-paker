"""
ZIP output packer for ws-ctx-engine.
...
class ZIPPacker:
    ...
    def pack(
        ...
        with zipfile.ZipFile(zip_buffer, "w", zipfile.ZIP_DEFLATED) as zip_file:
            ...
            manifest_content = self._generate_manifest(
                selected_files, repo_path, metadata, importance_scores
            )
    ...
    def _generate_manifest(
        ...
        files_with_scores = [
            (file_path, importance_scores.get(file_path, 0.0)) for file_path in selected_files
        ]
        ...
        lines.append("---")
        lines.append("")
        lines.append("*This context was generated by ws-ctx-engine*")
        lines.append("")

        return "\n".join(lines)

    def _get_inclusion_reason(self, file_path: str, score: float, metadata: dict[str, Any]) -> str:
        """
