...
class PrettyPrinter:
    ...
    def format(self, chunks: list[CodeChunk]) -> str:
        ...
        if language not in ("python", "javascript", "typescript"):
            raise ValueError(
                f"Unsupported language: {language}. " f"Supported: python, javascript, typescript"
            )
            ...
            for j, other in enumerate(sorted_chunks):
                if i != j:
                    ...
                    if (
                        ...
                        and chunk.end_line <= other.end_line
                        and chunk.path == other.path
                    ):
                ...
                if i != j:
                    ...
                    if (
                        ...
                        if parent_content.startswith(
                            ("class ", "function ", "async function ", "const ", "let ", "var ")
                        ):
                            is_nested = True
                            break
