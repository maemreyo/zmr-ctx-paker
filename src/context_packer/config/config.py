"""
Configuration management for Context Packer.

Loads settings from .context-pack.yaml with validation and default fallback.
"""
...
class Config:
    ...
    def load(cls, path: str = ".context-pack.yaml") -> 'Config':
        ...
        Args:
            path: Path to configuration file (default: .context-pack.yaml)
