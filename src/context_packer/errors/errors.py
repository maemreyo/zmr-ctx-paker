"""
Custom exceptions for Context Packer with actionable suggestions.
...
class ContextPackerError(Exception):
    """
    Base exception for Context Packer with actionable suggestions.
    
    All Context Packer exceptions should inherit from this class and provide
...
class ConfigurationError(ContextPackerError):
    ...
    def invalid_value(cls, field: str, value: any, expected: str) -> 'ConfigurationError':
        ...
        return cls(
            ...
            suggestion=f"Update .context-pack.yaml with valid {field} value"
        )
    ...
    def missing_file(cls, path: str) -> 'ConfigurationError':
        ...
        Example:
            ...
            ...     path=".context-pack.yaml"
            ... )
        """
        return cls(
            message=f"Configuration file not found: {path}",
            suggestion="Create .context-pack.yaml or use default configuration"
        )
    ...
    def invalid_format(cls, format_value: str) -> 'ConfigurationError':
        ...
        return cls(
            ...
            suggestion="Use 'xml' or 'zip' in .context-pack.yaml"
        )


class ParsingError(ContextPackerError):
    """
...
class IndexError(ContextPackerError):
    """
    ...
    def corrupted_index(cls, index_path: str) -> 'IndexError':
        ...
        Example:
            ...
            ...     index_path=".context-pack/vector.idx"
            ... )
        """
        return cls(
            message=f"Index file is corrupted: {index_path}",
            suggestion="Delete the index and rebuild with 'context-pack index <repo_path>'"
        )
    ...
    def stale_index(cls, index_path: str) -> 'IndexError':
        ...
        return cls(
            ...
            suggestion="Rebuild the index with 'context-pack index <repo_path>'"
        )


class BudgetError(ContextPackerError):
    """
    ...
    def budget_exceeded(cls, required: int, available: int) -> 'BudgetError':
        ...
        return cls(
            ...
            suggestion="Increase token_budget in .context-pack.yaml or reduce file selection"
        )
    ...
    def no_files_fit(cls, budget: int, smallest_file_size: int) -> 'BudgetError':
        ...
        return cls(
            ...
            suggestion="Increase token_budget in .context-pack.yaml"
        )
