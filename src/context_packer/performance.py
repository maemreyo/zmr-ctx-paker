"""
Performance monitoring and metrics tracking for Context Packer.
...
class PerformanceTracker:
    ...
    token counts, and memory usage during Context Packer operations.
    ...
    def __init__(self):
        ...
        self._indexing_start: Optional[float] = None
