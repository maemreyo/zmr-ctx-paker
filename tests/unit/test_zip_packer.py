    ...
    def test_zip_preserves_directory_structure(self):
        ...
        **Validates: Requirements 7.1, 7.2**
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Pack files
            packer = ZIPPacker()
            metadata = {"repo_name": "test-repo", "file_count": len(files), "total_tokens": 100}
            importance_scores = dict.fromkeys(files, 0.5)
            ...
            with zipfile.ZipFile(io.BytesIO(zip_bytes), "r") as zip_file:
                ...
                for file_path in files:
                    ...
                    assert (
                        expected_path in normalized_contents
    ...
    def test_files_are_under_files_directory(self):
        ...
        **Validates: Requirements 7.2**
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Pack files
            packer = ZIPPacker()
            metadata = {"repo_name": "test-repo", "file_count": 2, "total_tokens": 50}
            importance_scores = dict.fromkeys(files, 0.5)
    ...
    def test_review_context_exists_in_zip_root(self):
        ...
        **Validates: Requirements 7.3**
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Pack file
            packer = ZIPPacker()
            metadata = {"repo_name": "test-repo", "file_count": 1, "total_tokens": 10}
            ...
            with zipfile.ZipFile(io.BytesIO(zip_bytes), "r") as zip_file:
                ...
                assert not "REVIEW_CONTEXT.md".startswith(
                    "files/"
                ), "REVIEW_CONTEXT.md must be in root, not under files/"

                # Verify it's readable
                manifest = zip_file.read("REVIEW_CONTEXT.md").decode("utf-8")
                assert len(manifest) > 0, "REVIEW_CONTEXT.md must not be empty"
    ...
    def test_empty_file_handling(self):
        ...
        **Validates: Requirements 7.1, 7.2**
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Pack file
            packer = ZIPPacker()
            metadata = {"repo_name": "test-repo", "file_count": 1, "total_tokens": 0}
            importance_scores = {file_path: 0.5}
            ...
            with zipfile.ZipFile(io.BytesIO(zip_bytes), "r") as zip_file:
                ...
                assert content == "", "Empty file content should be preserved"
...
"""
            ...
            # Pack file
            packer = ZIPPacker()
            metadata = {"repo_name": "test-repo", "file_count": 1, "total_tokens": 50}
            importance_scores = {file_path: 0.5}
            ...
            with zipfile.ZipFile(io.BytesIO(zip_bytes), "r") as zip_file:
                ...
                assert content == unicode_content, "Unicode content should be preserved exactly"
    ...
    def test_special_characters_in_filenames(self):
        ...
        **Validates: Requirements 7.1, 7.2**
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            files = ["test-file.py", "test_file.py", "test.file.py"]
            ...
            # Pack files
            packer = ZIPPacker()
            metadata = {"repo_name": "test-repo", "file_count": len(files), "total_tokens": 50}
            importance_scores = dict.fromkeys(files, 0.5)
    ...
    def test_inclusion_reason_for_changed_files(self):
        ...
        **Validates: Requirements 7.5**
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            importance_scores = {"changed.py": 0.8, "unchanged.py": 0.5}
    ...
    def test_inclusion_reason_based_on_score(self):
        ...
        **Validates: Requirements 7.5**
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            packer = ZIPPacker()
            metadata = {"repo_name": "test-repo", "file_count": 3, "total_tokens": 100}
            importance_scores = {
            ...
            with zipfile.ZipFile(io.BytesIO(zip_bytes), "r") as zip_file:
                ...
                assert (
                    "Semantic match" in manifest
                    or "Dependency" in manifest
                    or "Transitive dependency" in manifest
                )
    ...
    def test_multiple_files_with_same_score(self):
        ...
        **Validates: Requirements 7.6**
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            packer = ZIPPacker()
            metadata = {"repo_name": "test-repo", "file_count": 3, "total_tokens": 50}
            importance_scores = dict.fromkeys(files, 0.5)
            ...
            with zipfile.ZipFile(io.BytesIO(zip_bytes), "r") as zip_file:
                ...
                for file_path in files:
                    assert file_path in manifest, f"File '{file_path}' should be in manifest"
                    assert "0.5000" in manifest, "Score should be in manifest"
