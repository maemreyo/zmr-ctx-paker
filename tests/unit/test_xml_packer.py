    ...
    def test_file_tags_include_paths_and_token_counts(self):
        ...
        **Validates: Requirements 6.3, 6.5**
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Pack files
            packer = XMLPacker()
            metadata = {"repo_name": "test-repo", "file_count": 2, "total_tokens": 100}
            xml_output = packer.pack(["src/main.py", "tests/test_main.py"], tmpdir, metadata)
    ...
    def test_large_file_handling(self):
        ...
        **Validates: Requirements 6.1, 6.5**
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Pack file
            packer = XMLPacker()
            metadata = {"repo_name": "test-repo", "file_count": 1, "total_tokens": 50000}
        ...
        **Validates: Requirements 6.3**
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            for i, file_elem in enumerate(file_elems):
                assert (
                    file_elem.attrib["path"] == file_names[i]
    ...
    def test_xml_declaration_present(self):
        ...
        **Validates: Requirements 6.7**
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert xml_output.startswith("<?xml"), "XML output should start with XML declaration"
