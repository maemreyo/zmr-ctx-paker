...
from ws_ctx_engine.graph import IGraphRepoMap, NetworkXRepoMap
...
def test_property_changed_file_score_boosting_networkx(chunks, changed_file_indices):
    ...
    changed_files = [unique_files[idx % len(unique_files)] for idx in changed_file_indices]
    ...
    for file in changed_files:
        if file in scores_before and file in scores_after:
            assert (
                scores_after[file] > scores_before[file]
