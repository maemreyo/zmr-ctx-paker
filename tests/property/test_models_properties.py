...
def code_chunk_strategy(draw):
    ...
    # Generate language
    language = draw(
        st.sampled_from(["python", "javascript", "typescript", "java", "go", "rust", "c", "cpp"])
    )
...
class TestCodeChunkProperties:
    ...
    def test_property_token_count_consistency(self, chunk):
        ...
        **Validates: Requirements 5.1**
        ...
        assert count1 == count2 == count3, f"Token count inconsistent: {count1}, {count2}, {count3}"
    ...
    def test_property_token_count_non_negative(self, chunk):
        ...
        **Validates: Requirements 5.1**
        ...
        assert token_count >= 0, f"Token count must be non-negative, got {token_count}"
    ...
    def test_property_empty_content_zero_tokens(self, content):
        ...
        **Validates: Requirements 5.1**
        ...
        if chunk.content == "":
            assert token_count == 0, f"Empty content should have 0 tokens, got {token_count}"
        else:
    ...
    def test_property_line_numbers_valid(self, chunk):
        ...
        **Validates: Requirements 1.1, 1.3, 1.4**
        ...
        assert chunk.end_line >= 1, f"end_line must be >= 1, got {chunk.end_line}"
        assert (
    ...
    def test_property_path_is_string(self, chunk):
        ...
        **Validates: Requirements 1.1**
        ...
        """
        assert isinstance(chunk.path, str), f"path must be a string, got {type(chunk.path)}"
        assert len(chunk.path) > 0, "path must not be empty"
    ...
    def test_property_longer_content_more_tokens(self, base_content):
        ...
        **Validates: Requirements 5.1**
        ...
        assert count2 >= count1, f"Extended content should have >= tokens: {count1} vs {count2}"
